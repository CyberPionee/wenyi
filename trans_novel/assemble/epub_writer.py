...
from trans_novel.assemble.epub_navigation import _is_nav, _rewrite_opf_metadata, _rewrite_toc
from trans_novel.assemble.epub_presentation import (
    _HTML_EXTS,
    _epub_looks_vertical,
    _inject_bilingual_style,
    _rewrite_html_document,
)
from trans_novel.assemble.epub_resources import _render_epub_resources
from trans_novel.assemble.html_renderer import (
    _render_chapter_html,
    _render_paragraph_html,
)
from trans_novel.assemble.html_resources import (
    _IMAGE_EXTENSION_BY_TYPE,
    _package_html_resources,
    _template_resource_source,
)
from trans_novel.assemble.writer_common import (
    _ch_title,
    _epub_lang,
    _export_book_title,
