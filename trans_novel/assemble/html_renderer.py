...
from trans_novel.assemble.html_bilingual import (
    _append_source,
    _bilingual_source_markup,
    _build_source_anchor_ids,
    _index_soup_ids,
)
from trans_novel.assemble.html_inline import _merge_epub_render_meta, _replace_block_content
from trans_novel.assemble.writer_common import _bilingual_source, _ordered_pair, _seg_text
from trans_novel.ingest.models import KIND_HEADING, Chapter, Segment
from trans_novel.markup.contracts import (
    ANNOTATION_ID_ATTR,
    INLINE_ID_ATTR,
    LINE_WRAPPER_ATTR,
)
...
def _render_segments_html(
    ...
    *,
    ...
    if bilingual and source_link_targets is None:
        ...
        from trans_novel.markup.anchors import fragment_anchor_map
