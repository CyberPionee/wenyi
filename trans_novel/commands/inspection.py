...
from trans_novel.commands import presentation
from trans_novel.ingest.errors import IngestError
from trans_novel.pipeline.runstore import STATUS_DONE
from trans_novel.timing import load_timing
...
def register_inspection_commands(app: typer.Typer, context: ContextAccessor) -> None:
    ...
    def languages() -> None:
        ...
        from trans_novel.i18n.languages import profile, supported_languages
