...
from trans_novel.ingest.epub_chapters import get_chapter_split_strategy
from trans_novel.ingest.models import KIND_HEADING, Chapter, Segment
from trans_novel.markup.anchors import fragment_nodes, resolve_epub_href, scope_segment_anchors
from trans_novel.markup.annotations import _note_context_scope
from trans_novel.markup.contracts import ANNOTATION_META_KEY
